...
.pmwb-validation-toolbar { display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-bottom: 22px; }
.pmwb-validation-toolbar label { display: flex; align-items: center; gap: 10px; color: var(--pmwb-muted); font-size: 12px; }
.pmwb .pmwb-validation select { padding: 7px 12px; border: 1px solid var(--pmwb-line); border-radius: 8px; background: #222222; font-size: 12px; }
...
.pmwb-validation-scope { display: grid; gap: 8px; margin: 15px 0; padding: 0; border: 0; }
.pmwb-validation-scope label { display: flex; align-items: center; gap: 10px; padding: 10px 12px; border-radius: 9px; background: rgba(255,255,255,.03); font-size: 13px; }
.pmwb-validation input[type=checkbox] { accent-color: #cccccc; width: 15px; height: 15px; flex-shrink: 0; }
.pmwb-validation-create-footer { display: flex; align-items: center; justify-content: space-between; gap: 24px; padding-top: 8px; }
.pmwb-validation-create-footer p { max-width: 54ch; font-size: 11px; }
.pmwb-validation-create-footer button { flex-shrink: 0; }
...
.pmwb-validation-history-row strong { font-size: 13px; font-weight: 530; overflow: hidden; text-overflow: ellipsis; }
...
.pmwb-validation-detail > h3 { margin-bottom: 6px; font-size: 22px; }
...
.pmwb-validation-plan > fieldset { display: grid; gap: 14px; margin: 20px 0 12px; padding: 0; border: 0; }
.pmwb-validation-plan label, .pmwb-poc-input > label, .pmwb-validation-judgment > label, .pmwb-controlled-demo > label { display: grid; gap: 7px; color: var(--pmwb-muted); font-size: 12px; }
...
.pmwb-validation-confirm { display: flex; align-items: center; justify-content: space-between; gap: 20px; padding: 16px 0; }
.pmwb-validation-confirm > label { display: flex; align-items: flex-start; gap: 10px; font-size: 12px; color: var(--pmwb-muted); }
...
.pmwb-validation-next { display: flex; align-items: center; justify-content: space-between; gap: 16px; margin-top: 18px; padding: 17px; border: 1px solid var(--pmwb-line); border-radius: 10px; }
.pmwb-validation-next p { color: var(--pmwb-muted); font-size: 12px; }
...
.pmwb-handoff > h3 { margin-bottom: 10px; font-size: 22px; }
...
@media (max-width: 820px) { .pmwb .pmwb-stepper { width: 100%; } }
...
@media (max-width: 640px) { .pmwb .pmwb-stepper button { flex-direction: column; gap: 5px; padding: 6px 4px; } .pmwb .pmwb-validation { padding: 19px 16px; } .pmwb-validation-modes { grid-template-columns: 1fr; } .pmwb .pmwb-validation-mode { min-height: auto; } .pmwb-validation-mode svg { margin-bottom: 10px; } .pmwb-validation-create-footer, .pmwb-validation-confirm, .pmwb-validation-next { align-items: flex-start; flex-direction: column; gap: 13px; } .pmwb-handoff dl { grid-template-columns: 1fr; } .pmwb-validation-badge { max-width: 78px; } }
