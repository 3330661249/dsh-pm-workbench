...
const hostApplicationInputs = new Set([
  ...
  "packages/workbench/src/analysis/source-segments.ts",
...
const reviewedImports = {
  ...
  "packages/workbench/src/analysis/harness-model-engine.ts": [["node_modules/zod/index.js","import-statement",false],["packages/workbench/src/domain/ids.ts","import-statement",false],["packages/workbench/src/domain/evidence.ts","import-statement",false],["packages/workbench/src/domain/limits.ts","import-statement",false],["packages/workbench/src/analysis/types.ts","import-statement",false],["packages/workbench/src/analysis/source-segments.ts","import-statement",false]],
  "packages/workbench/src/analysis/source-segments.ts": [["packages/workbench/src/domain/limits.ts","import-statement",false]],
  "packages/workbench/src/analysis/types.ts": [],
  "packages/workbench/src/application/clock.ts": [],
  ...
  "packages/workbench/src/integration/harness-rc6/subagent-analysis-runner.ts": [["packages/workbench/src/analysis/harness-model-engine.ts","import-statement",false],["packages/workbench/src/analysis/types.ts","import-statement",false],["packages/workbench/src/analysis/source-segments.ts","import-statement",false]],
  ...
  "packages/workbench/src/validation/model.ts": [["node_modules/zod/index.js","import-statement",false],["packages/workbench/src/domain/limits.ts","import-statement",false]],
  ...
  "packages/workbench/src/validation/runner.ts": [["packages/workbench/src/domain/limits.ts","import-statement",false],["packages/workbench/src/validation/model.ts","import-statement",false]],
